export namespace AnotherNamespace {
    export type SomeClass = {
        key: 'AnotherNamespace.SomeClass';
...
export namespace System {
    ...
    export type MulticastDelegate1$AnotherNamespace_SomeClass = {
        key: 'System.Action`1[[AnotherNamespace.SomeClass, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]';
    }
}
export namespace Nahoum.UnityJSInterop.Tests {
    ...
    export type TestActionCallbacks = {
        ...
        TestInvokeActionWithClassOutsideNamespace(action: System.MulticastDelegate1$AnotherNamespace_SomeClass): void;
    }
