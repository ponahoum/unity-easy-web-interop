...
TestInvokeActionWithClassOutsideNamespace(action: System.Action1$AnotherNamespace_SomeClass): void;
...
get managedType(): System.Type;
GetString(): System.String;
}& ITestInterfaceForBaseClass& TestBasicInheritance_static;
...
GetString(): System.String;
}& ITestInterfaceForBaseClass& TestBasicInheritance& SuperTestBasicInheritance_static;
...
export type UnityInstance = {
    Module: {
        static: {
            "Nahoum.UnityJSInterop.Tests": {TestAbstractClass: Nahoum.UnityJSInterop.Tests.TestAbstractClass_static;
...
TestStructExpose: Nahoum.UnityJSInterop.Tests.TestStructExpose_static;
        ...
        utilities: Utilities,
        extras:{
            "System": {"Action": { createDelegate: (callback: () => void) => System.Action };
"Action<Int32>": { createDelegate: (callback: (a: System.Int32) => void) => System.Action1$Int32 };
"Action<String>": { createDelegate: (callback: (a: System.String) => void) => System.Action1$String };
"Action<Single>": { createDelegate: (callback: (a: System.Single) => void) => System.Action1$Single };
"Action<Double,String>": { createDelegate: (callback: (a: System.Double, b: System.String) => void) => System.Action2$Double$String };
"Action<AnotherNamespace.SomeClass>": { createDelegate: (callback: (a: AnotherNamespace.SomeClass) => void) => System.Action1$AnotherNamespace_SomeClass };
},
        }
    }
}
